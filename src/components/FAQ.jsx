...
const FAQS = [
  ...
  },
  {
    ...
    a: {
      en: "macOS 14 Sonoma or later. Native on Apple Silicon and Intel.",
      zh: "需要 macOS 14 Sonoma 或更高版本。",
      ja: "macOS 14 Sonoma以降が必要です。",
      ko: "macOS 14 Sonoma 이상이 필요합니다.",
      fr: "macOS 14 Sonoma ou ultérieur.",
      de: "macOS 14 Sonoma oder neuer.",
      it: "macOS 14 Sonoma o successivo.",
      es: "macOS 14 Sonoma o posterior.",
    },
  },
  {
    q: {
